...
def main():
    ...
    categories_url = "https://www.zebupetcenter.com.br/cachorros.html?cat=11&limit=all"
    ...
    # Defina a categoria principal
    main_category = 'Cachorros'
    ...
    for index, row in enumerate(product_links):
        ...
        # Crie o diretório com o nome da categoria principal (por exemplo, 'Cachorros')
        create_directory(main_category)

        # Defina a subcategoria (por exemplo, 'Higiene e Limpeza')
        sub_category = 'Higiene e Limpeza'

        # Crie o diretório com o nome da subcategoria dentro da categoria principal
        sub_category_directory = os.path.join(main_category, sub_category)
        create_directory(sub_category_directory)

        # Crie o diretório com o nome do produto (limpo) dentro da subcategoria
