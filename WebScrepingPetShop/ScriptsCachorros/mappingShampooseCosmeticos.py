...
def main():
    ...
    categories_url = "https://www.zebupetcenter.com.br/cachorros.html?cat=23&limit=all"
    ...
    for index, row in enumerate(product_links):
        ...
        product_name, product_description, product_image_url, product_price = extract_product_info(
            page_source)  # Obtém o preço

        # Diretório com o nome da categoria principal (por exemplo, 'Cachorros')
        create_directory(main_category)

        sub_category = 'Shampoos e Cosméticos'
